...
<div class="p-2 rounded-xl w-1/2 mx-auto border-2 border-black shadow-xl">
    <form class="max-w-sm mx-auto" method="POST" action="{{route('categories.store')}}">
        ...
        <div class="mb-5">
            ...
            <input type="text" value="{{@old('nombre')}}" name="nombre" id="nombre" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
            @error('nombre')
            <x-error>
                {{$message}}
            </x-error>
        ...
        <div class="flex justify-between">
            ...
            <button type="reset" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                <i class="fas fa-paintbrush">&nbsp;Reset</i>
            </button>
